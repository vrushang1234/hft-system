...
// Wrapper module for 2 primitive RAMB36E1 instances combined into a 72-bit wide by 1K deep block
// ID[16 bits] Price(0.0001 increment)[30 bits] Quantity[16 bits] Valid[1 bit] Buy/Sell[1 bit] Total[64 bits]
//////////////////////////////////////////////////////////////////////////////////

module RAMB72_Wrapper#(
    ...
    generate
        for (i = 0; i < 2; i = i + 1) begin
            RAMB36E1 #(
                ...
                .DOPADOP       (rd_data[(i+1)*BLOCK_WIDTH-1 : i*BLOCK_WIDTH+DATA_BITS]),         // 4-bit output: A port parity/LSB parity
                ...
                .DIPBDIP       (wr_data[(i+1)*BLOCK_WIDTH-1 : i*BLOCK_WIDTH+DATA_BITS])          // 4-bit input: B port parity/MSB parity
            );
        end
    endgenerate
